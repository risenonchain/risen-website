...
import { Zap, Lock, RefreshCw, ChevronLeft } from "lucide-react";
...
export default function BridgeLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#01070e] text-slate-200 relative overflow-hidden font-sans">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-600/5 blur-[100px] rounded-full -z-10" />
      ...
      <div className="w-full max-w-md px-6">
        ...
        >
            ...
            <h2 className="text-3xl font-black text-white mb-2 text-center tracking-tighter uppercase italic">Neural Access</h2>
            <p className="text-blue-500 mb-8 text-center text-[10px] font-black uppercase tracking-[0.4em] italic">
                Bridge Node Authorization
            </p>
            ...
            <div className="w-full space-y-4">
                <div className="space-y-1.5">
                    ...
                    <input
                        ...
                        className="w-full px-6 py-4 rounded-2xl bg-black/40 border border-white/5 text-white text-xs font-black outline-none focus:border-blue-500/50 transition-all placeholder:text-white/10 uppercase tracking-widest"
                        required
                    />
                </div>
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 rounded-2xl bg-black/40 border border-white/5 text-white text-xs font-black outline-none focus:border-blue-500/50 transition-all placeholder:text-white/10"
                            required
                        />
            ...
            <button
                type="submit"
                disabled={loading}
                className="w-full mt-8 py-5 rounded-[28px] bg-white text-black font-black uppercase text-[11px] tracking-[0.3em] shadow-lg shadow-white/5 hover:bg-blue-500 hover:text-white transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-3"
            >
