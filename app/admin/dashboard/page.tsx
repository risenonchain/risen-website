export default function DashboardHome() {
  return (
    <div className="rounded-3xl bg-[#101828] border border-white/10 p-10 min-h-[60vh] shadow-xl flex flex-col items-center justify-center">
      <h1 className="text-3xl font-extrabold mb-4 text-risen-primary">Welcome to the RISEN Admin Dashboard</h1>
      ...
      <div className="flex gap-6 mt-4">
        <div className="rounded-2xl bg-[#07111d] border border-risen-primary/20 p-6 min-w-[220px] flex flex-col items-center">
        ...
        <div className="rounded-2xl bg-[#07111d] border border-yellow-400/20 p-6 min-w-[220px] flex flex-col items-center">
        ...
        <div className="rounded-2xl bg-[#07111d] border border-purple-400/20 p-6 min-w-[220px] flex flex-col items-center">
          <span className="text-4xl mb-2">📜</span>
