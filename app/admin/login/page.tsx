...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0a101a] to-[#18102a] relative overflow-hidden">
      ...
      {alreadyLoggedIn ? (
        <div className="relative z-10 bg-[#101828]/90 p-10 rounded-3xl shadow-2xl w-full max-w-md border border-yellow-400/20 backdrop-blur-xl flex flex-col items-center">
          <Image src="/logo.png" alt="RISEN Logo" width={64} height={64} className="mb-4" />
          <h2 className="text-3xl font-extrabold text-yellow-300 mb-2 text-center tracking-tight drop-shadow">Already Logged In</h2>
          <div className="text-white/80 mb-6 text-center text-base font-medium">
            You are already logged in as admin on this browser.<br />
            Please logout before logging in again.
          </div>
        </div>
      ) : (
        <form
