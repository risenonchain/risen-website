  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-risen-navy to-[#18102a] relative overflow-hidden">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-2 rounded-lg bg-gradient-to-r from-risen-primary to-cyan-700 text-white font-bold text-lg shadow-lg hover:from-cyan-400 hover:to-cyan-700 transition disabled:opacity-60"
          disabled={loading}
        >
